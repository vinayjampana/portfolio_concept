    ...
    data() {
      return {
        ...
        descriptionArr: [
          ...
          'A SaaS product built to solve procurement and accounting problems for various clients across all domains. was part of aggressive frontend development team where I built and maintained a lot of modules. ',
          'Progressive Web Application where I implemented all the major functionalities of Aerchain product from scratch which solved the responsiveness issue',
          'Python application which was used to implement git functionality on a Command Line Interface',
          'Product built for users to track and predict thier investment patterns in Steam Community Market ', /* Depends mostly on detection and tracking of cars and their number plates. */
        ],
        textArr: [
          `Hash`,
          `Aerchain`,
        ...
        imgArr: [require('../assets/hash.png'), require('../assets/aerchain.png'), require('../assets/mobile_app.png'), require('../assets/parser.png'), require('../assets/investment.svg')],
        currentSlideNum: 0
      }
    },
    mounted: function () {
